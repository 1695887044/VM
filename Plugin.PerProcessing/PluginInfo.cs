...
namespace Plugin.PerProcessing
{
    ...
    {
        public string PluginName => "PerProcessing";
        ...
        public string Description => "PerProcessing";
        public Type ViewType => typeof(PerPrecessView);
        public Type ViewModelType => typeof(PerPrecessViewModel);
        public int Code => 200;
    }
}
