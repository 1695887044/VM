...
namespace DemoThemes.ThemeCs
{
    public class LabelLinkPath : Control
    {
        ...
        public static readonly DependencyProperty BindModeProperty = DependencyProperty.Register(
            "BindMode",
            typeof(bool),
            typeof(LabelLinkPath),
        ...
        public static readonly DependencyProperty LinkParamProperty = DependencyProperty.Register(
            "LinkParam",
            typeof(string),
            typeof(LabelLinkPath),
