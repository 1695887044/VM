...
namespace HalconDemo.ThemeCodes
{
    ...
    public class ImageEdit:Control
    {
        ...
        {
            get { return (string)GetValue(TopTextPropertyProperty); }
            set { SetValue(TopTextPropertyProperty, value); }
        }
        public static readonly DependencyProperty TopTextPropertyProperty =
            DependencyProperty.Register("TopTextProperty", typeof(string), typeof(ImageEdit), new PropertyMetadata(string.Empty));
        ...
        {
            get { return (string)GetValue(BottomPropertyProperty); }
            set { SetValue(BottomPropertyProperty, value); }
        }

        public static readonly DependencyProperty BottomPropertyProperty =
            DependencyProperty.Register("BottomProperty", typeof(string), typeof(ImageEdit), new PropertyMetadata(string.Empty));
